...
class GeneralSettings extends SettingsPage {
    init() {
        ...
        this.registerFormElement('fen_refresh', 'Fen Refresh Interval (ms):', 'input', 50);
        const multipv_range = this.registerFormElement('multiple_lines', 'Multiple Lines:', 'range', 1);
        const threads_range = this.registerFormElement('threads', 'Threads:', 'range', 4);
        const memory_range = this.registerFormElement('memory', 'Memory:', 'range', 256);
        ...
        this.registerFormElement('move_variance', 'Simulated Move Variance (ms):', 'input', 200);
